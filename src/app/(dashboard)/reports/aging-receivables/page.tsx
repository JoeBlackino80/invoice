...
import type { AgingReport, AgingBucket } from "@/lib/reports/financial-reports"
...
export default function AgingReceivablesPage() {
  ...
  const exportCsv = () => {
    ...
    link.href = url
    link.download = `aging-pohladavok-${asOfDate}.csv`
    link.click()
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Analyza neuhradanych vydanych faktur podla doby po splatnosti
          </p>
        </div>
            ...
            <Card className="mb-6">
              <CardHeader>
                <CardTitle className="text-sm font-medium">
                  Rozdelenie pohladavok - celkovo {formatEur(report.total_outstanding)}
                </CardTitle>
              </CardHeader>
              <CardContent>
